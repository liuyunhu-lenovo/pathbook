...
public void test_AuthController() throws ParseException {
    ...
    // 模拟三级负责人审批
    logger.info("测试结果：{}", JSON.toJSONString(authController.doAuth("柳叶枫", "1000998004813441", new Date())));
...
public void test_AuthLink() throws ParseException {
    ...
    logger.info("测试结果：{}", JSON.toJSONString(authLink.doAuth("柳叶枫", "1000998004813441", new Date())));
